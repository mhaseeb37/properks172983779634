    ...
    updateFilters(url) {
        ...
        this.getFromUrl(url).then(html => {
            filters.forEach(filter => {
                ...
                var fillter_mfilterd=html.querySelector("#ShopActiveFilters");
                var myHtml=document.querySelector("#FiltersDesktop #ShopActiveFilters");
              console.log(html)
              console.log(fillter_mfilterd);
              
              myHtml.innerHTML=fillter_mfilterd.innerHTML;
...
document.addEventListener('click', function(event) {
  ...
  if(event.target.closest('.close-btn')){
    ...
    let modal_content_div = parent_div.querySelector('.model-data');
     let innermodal_div = document.querySelector('.custom_m_l');
